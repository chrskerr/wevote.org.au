	...
	<div class="whitepaper">
		<div class="section">
			<div class="container">
				...
				<details>
					<summary class="subtitle" id='summary'>Summary</summary>
				...
				<details>
					<summary class="subtitle" id="problem">The Problem</summary>
					<div class='box has-background-white-bis'>
						<p>
				...
				<details>
					<summary class="subtitle" id="solution">This Solution</summary>
					<div class='box has-background-white-bis'>
						<p>
				...
				<details>
					<summary class="subtitle" id="technologies">Technologies</summary>
					<div class='box has-background-white-bis'>
						<p>
				...
				<details>
					<summary class="subtitle" id="next">Whats next / How can you help</summary>
					<div class='box has-background-white-bis'>
						<p>
